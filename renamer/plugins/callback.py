...
DWLrenamer.on_callback_query(filters.regex('^help$'))
...
DWLrenamer.on_callback_query(filters.regex('^close$'))
...
DWLrenamer.on_callback_query(filters.regex('^back$'))
...
DWLrenamer.on_callback_query(filters.regex('^about$'))
