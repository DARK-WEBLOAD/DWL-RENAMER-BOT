...
from pyrogram import Client as DWLrenamer, filters
...
@DWLrenamer.on_message(filters.command("help") & filters.private & filters.incoming)
async def help(c, m, cb=False):
    button = [[
        InlineKeyboardButton(f'{HOUSE_WITH_GARDEN} ʜᴏᴍᴇ', callback_data='back'),
        InlineKeyboardButton(f'{MONEY_BAG} ᴅᴏɴᴀᴛᴇ', callback_data='donate')
        ],[
...
@DWLrenamer.on_message(filters.command("start") & filters.private & filters.incoming)
async def start(c, m, cb=False):
    ...
    button = [[
        ...
        InlineKeyboardButton(f'{INFORMATION} ʜᴇʟᴘ', callback_data="help"),
        InlineKeyboardButton(f'{NO_ENTRY} ᴄʟᴏsᴇ', callback_data="close")
    ]]
    reply_markup = InlineKeyboardMarkup(button)
    if cb:
...
@DWLrenamer.on_message(filters.command("about") & filters.private & filters.incoming)
...
@DWLrenamer.on_message(filters.command("mode") & filters.private & filters.incoming)
...
@DWLrenamer.on_message(filters.command("reset") & filters.private & filters.incoming)
...
@DWLrenamer.on_message(filters.command('login') & filters.incoming & filters.private)
